...
_$_DashboardItem _$_$_DashboardItemFromJson(Map<String, dynamic> json) {
  return _$_DashboardItem(
    ...
    createdTimeStamp:
        DashboardItem._dateTimeFromUTC(json['created_at'] as String),
    updatedTimeStamp:
        DashboardItem._dateTimeFromUTC(json['updated_at'] as String),
...
Map<String, dynamic> _$_$_DashboardItemToJson(_$_DashboardItem instance) =>
    <String, dynamic>{
      ...
      'created_at': DashboardItem._dateTimeToUTC(instance.createdTimeStamp),
      'updated_at': DashboardItem._dateTimeToUTC(instance.updatedTimeStamp),
