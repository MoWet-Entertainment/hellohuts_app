...
class SearchCategoriesState extends AppState {

  //TODO: Try to keep only one search class instead of having separatte classes .
    var logger = getLogger('SearchCategoriesState');
...
//When user clicks on the search results, value gets stored in the selectedItem
  ...
  List<SearchItem> getSearchResults() {
    ...
    var list = MockSearch.categoriesSearchList;
